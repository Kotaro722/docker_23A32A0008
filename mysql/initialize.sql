...
insert into project_table (id, name, example_number, example_message) values (1, 'test1', 10, 'message1');
insert into project_table (id, name, example_number, example_message) values (2, 'test2', 20, 'message2');
insert into project_table (id, name, example_number, example_message) values (3, 'test3', 30, 'message3');
